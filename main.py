...
def main():
    ...
    days = st.sidebar.selectbox("Number of days of data to generate", [30, 45, 60, 90], index=0)
    ...
    for region in AWS_REGIONS:
        selected_regions[region] = st.sidebar.checkbox(f"Region: {region}", key=f"region_{region}", value=region in ['us-east-1', 'us-west-2', 'eu-west-1'])
